...
// // // app/routes/api.savecollections-database.jsx
...
// //       for (const productEdge of coll.products.edges) {
// //         const shopifyProduct = productEdge.node;
// //         const variant = shopifyProduct.variants.edges[0]?.node;

// //         if (variant) {
// //           let product = await prisma.product.findFirst({
// //             where: { shopify_product_id: shopifyProduct.id, sessionId: session.id }
// //           });
...
// //     // Clean up VideoCollection entries not in the new list
// //     await prisma.videoCollection.deleteMany({
// //       where: {
// //         video_id: video.id,
// //         collection_id: { notIn: collectionIds.map(id => parseInt(id)) }
// //       }
// //     });
