...
// In ProductsModal.jsx - Get the correct video's selected products

import { useState } from "react";
export default function ProductsModal({
  showProductsModal,
  products,
  selectedProducts, // This is now a Map
  loadingProducts,
  onToggleProduct,
  onSaveProducts,
  onHide,
  ...
  // FIX: Get selected products for THIS specific video
  ...
  // Debug logging
  console.log("🔍 ProductsModal - Video ID:", videoId);
  console.log(
    "🔍 ProductsModal - Selected products for this video:",
    Array.from(videoSelectedProducts),
  );
  console.log("🔍 ProductsModal - Total products:", products.length);
          ...
          {loadingProducts ? (
            ...
            <>
                ...
                {filteredProducts.length === 0 ? (
                  ...
                  filteredProducts.map((product) => (
                    ...
                    >
                      <input
                        type="checkbox"
                        checked={videoSelectedProducts.has(product.id)} // Use video-specific selection
                        onChange={() => onToggleProduct(product.id)}
                        style={{
                          width: "20px",
                          height: "20px",
              ...
              >
                ...
                >
                  SAVE ({videoSelectedProducts.size}){" "}
                  {/* Use video-specific count */}
                </button>
                <button
                  onClick={onHide}
                  style={{
