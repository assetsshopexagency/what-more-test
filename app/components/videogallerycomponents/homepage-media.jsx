...
//     console.log("🔄 Starting upload for:", customFileName, "Size:", file.size, "bytes");

//     // Better progress simulation
//     let progress = 0;
//     const progressInterval = setInterval(() => {
//       progress += 5;
//       if (progress <= 90) { // Leave room for actual upload completion
//         onProgress(progress);
//       }
//     }, 300);

//     try {
//       // Call our upload API without timeout for better reliability
//       const response = await fetch('/api/upload-media', {
//         method: 'POST',
//         body: formData,
//       });
...
//           url: result.fileUrl,
//           shopifyFileId: result.shopifyFileId,
//           note: result.note || result.message || 'Uploaded to Shopify'
//         };
//       } else {
//         throw new Error(result.error || 'Upload failed - no specific error message');
//       }
